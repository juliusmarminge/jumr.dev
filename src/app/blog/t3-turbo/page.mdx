...
```ts filename="packages/api/src/context.ts"
import { prisma } from "@acme/db";
```

```ts filename="apps/nextjs/src/utils/trpc.ts"
...
```ts filename="apps/nextjs/src/pages/api/trpc/[trpc].ts"
...
```ts filename="types/nativewind.d.ts"
...
```tsx filename="src/screens/home.tsx"
...
```tsx filename="apps/nextjs/src/pages/index.tsx"
...
```tsx filename="apps/expo/src/screens/Home.tsx"
const PostCard: React.FC<{
  post: RouterOutputs["post"]["all"][number];
}> = ({ post }) => {
  return (
