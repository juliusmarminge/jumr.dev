...
_Your repo should look something like [this](https://github.com/juliusmarminge/create-t3-turbo/tree/9151258225518a1a44d7aa45c49f0b33ebb9933c) now._
...
- [package.json](https://github.com/juliusmarminge/create-t3-turbo/blob/main/package.json)
- [turbo.json](https://github.com/juliusmarminge/create-t3-turbo/blob/main/turbo.json)
...
- [tsconfig.base.json](https://github.com/juliusmarminge/create-t3-turbo/blob/main/tsconfig.base.json)
- [apps/nextjs/tsconfig.json](https://github.com/juliusmarminge/create-t3-turbo/blob/main/apps/nextjs/tsconfig.json)
...
_Your repo should look something like [this](https://github.com/juliusmarminge/create-t3-turbo/tree/208f2c8e0de03165e4fb23071f4df5b85628bd24) now._
...
- [package.json](https://github.com/juliusmarminge/create-t3-turbo/blob/main/packages/db/package.json)
- [tsconfig.json](https://github.com/juliusmarminge/create-t3-turbo/blob/main/packages/db/tsconfig.json)
...
_Your repo should now look something like [this](https://github.com/juliusmarminge/create-t3-turbo/tree/5f8117aaacc2713d2719e7d12b04d82d984d14fa)._
...
- [package.json](https://github.com/juliusmarminge/create-t3-turbo/blob/main/packages/api/package.json)
- [tsconfig.json](https://github.com/juliusmarminge/create-t3-turbo/blob/main/packages/api/tsconfig.json)
...
When you're done, your repo should look something like [this](https://github.com/juliusmarminge/create-t3-turbo/tree/8550e4648b21d0edd037f98e256dcb089e530ae3).
...
_Your repo should now look something like [this](https://github.com/juliusmarminge/create-t3-turbo/tree/789f952256932033a03e57658f18b48ac7833945)_
...
_At this point, your repo should look something like [this](https://github.com/juliusmarminge/create-t3-turbo/tree/6709d7f417474a82e83150a72a1ac73c62f02c26)._
...
_At this point, your repo should look something like [this](https://github.com/juliusmarminge/create-t3-turbo/tree/61dc5cbb1ad67d6566fe7eb5208b694cb12dc304)._
...
For now, I'll just add a few example posts using Prisma Studio. The resulting repo looks something like [this](https://github.com/juliusmarminge/create-t3-turbo/tree/af11f71f651e919e80038828fbb15b95f5886451), and we can now consume this on both the Next.js and Expo applications.
...
![Screenshot](https://user-images.githubusercontent.com/51714798/185813523-7882d03d-1449-4a07-8771-c45af37025a8.png)

## Final Words

Thank you for reading this post. This was my first ever post, so if you enjoyed it, go give the repo a [star](https://github.com/juliusmarminge/create-t3-turbo/stargazers). If it helped you out, consider [buying me a coffee](https://github.com/sponsors/juliusmarminge), I would truly appreciate it!
