...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-sm opacity-70 transition-opacity focus:outline-none focus:ring-2 focus:ring-stone-400 focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-stone-100 hover:opacity-100 dark:focus:ring-stone-400 dark:focus:ring-offset-stone-900 dark:data-[state=open]:bg-stone-800">
        <X className="h-4 w-4" />
